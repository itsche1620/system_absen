...
Route::get('/pelanggaran/download', [PelanggaranController::class, 'download'])->name('generate.pelanggaran');
...
// helper
Route::GET('/sipensi/carisiswa', [studentController::class, "carisiswa"])->name("helper.carisiswa");
