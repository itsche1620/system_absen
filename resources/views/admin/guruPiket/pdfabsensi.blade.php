                            ...
                            <td
                                ...
                                @if (isset($attendanceData[$siswa->nama_siswa][$day]))
                                    ...
                                    @elseif ($attendanceData[$siswa->nama_siswa][$day] === 'Izin')
                                        <span
                                            style="font-weight: bold; background-color: #FCCD2A; padding: 3px; border-radius: 2px;">I</span>
                                    @elseif ($attendanceData[$siswa->nama_siswa][$day] === 'Magang')
                                        <span
                                            style="font-weight: bold; color: #156681; padding: 3px; border-radius: 2px;">M</span>
                                    @endif
                                @elseif (!$isWeekend)
                                    <span></span>
                                @endif
